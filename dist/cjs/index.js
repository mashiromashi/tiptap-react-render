...
function TipTapRender(props) {
    ...
    node.content && node.content.forEach(function (child, ix) {
        children.push(React.createElement(TipTapRender, { node: child, handlers: mapping, key: "".concat(child.type, "-").concat(ix) }));
    });
    ...
    return React.createElement(Handler, { node: node }, children);
}
